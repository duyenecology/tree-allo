...
fit_lr_nou_draws_pl_ang_h <- tar_read(fit_lr_nou_draws_pl_ang_h)
fit_lr_nou_draws_pl_ang_h

r2_pl_nou_h_ang <- calculate_bayes_R2(
  stan_data_lr_ang_h,
  fit_lr_nou_draws_pl_ang_h,
  c("gamma[1]", "gamma[2]"),
  "lr"
...
fit_nlr_nou_draws_gmm_ang_h <- tar_read(fit_nlr_nou_draws_gmm_ang_h)
fit_nlr_nou_draws_gmm_ang_h

r2_gmm_nou_h_ang <- calculate_bayes_R2(
  stan_data_nlr_ang_h,
  fit_nlr_nou_draws_gmm_ang_h,
...
fit_nlr_nou_draws_weibull_ang_h <- tar_read(fit_nlr_nou_draws_weibull_ang_h)
fit_nlr_nou_draws_weibull_ang_h

r2_weibull_nou_h_ang <- calculate_bayes_R2(
  stan_data_nlr_ang_h,
  fit_nlr_nou_draws_weibull_ang_h,
  c("gamma[1]", "gamma[2]", "gamma[3]"),
  "weibull"
