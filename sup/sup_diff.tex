...
%DIF DEL sup_old.tex   Thu Mar 27 08:01:05 2025
%DIF ADD sup.tex       Thu Mar 27 07:59:43 2025
...
\DIFdelbegin \DIFdel{TableS6\_height\_sp\_estimates.xlsx}\DIFdelend \DIFaddbegin \emph{\DIFadd{TableS6\_height\_sp\_estimates.xlsx}}\DIFaddend ).

\textbf{Table S7.} Parameter estimates for predicting crown radius (m)
from DBH (cm) of 821 species (see file
\DIFdelbegin \DIFdel{TableS7\_crown\_radius\_sp\_estimates.xlsx}\DIFdelend \DIFaddbegin \emph{\DIFadd{TableS7\_crown\_radius\_sp\_estimates.xlsx}}\DIFaddend ).

\textbf{Table S8.} Parameter estimates for predicting DBH (cm) from
crown radius (m) and tree height (m) of 800 species (see file
\DIFdelbegin \DIFdel{TableS8\_dbh\_sp\_estimates.xlsx}\DIFdelend \DIFaddbegin \emph{\DIFadd{TableS8\_dbh\_sp\_estimates.xlsx}}\DIFaddend ).
...
\DIFaddbegin \addlinespace
\DIFadd{6 }& \DIFadd{Zanne }& \DIFadd{Amy }& \DIFadd{61 }& \DIFadd{Global Wood Density Database}\\
\DIFadd{7 }& \DIFadd{Weiher }& \DIFadd{Evan }& \DIFadd{66 }& \DIFadd{Midwestern and Southern US Herbaceous Species Trait Database}\\
\DIFadd{8 }& \DIFadd{Cornelissen }& \DIFadd{Johannes }& \DIFadd{72 }& \DIFadd{Sheffield \& Spain Woody Database}\\
\DIFadd{9 }& \DIFadd{Bond }& \DIFadd{William }& \DIFadd{47 }& \DIFadd{South African Woody Plants Database (ZLTP)}\\
\DIFadd{10 }& \DIFadd{Ordonez }& \DIFadd{Jenny }& \DIFadd{88 }& \DIFadd{The Netherlands Plant Traits Database}\\
\addlinespace
\DIFadd{11 }& \DIFadd{Peuelas }& \DIFadd{Josep }& \DIFadd{91 }& \DIFadd{Catalonian Mediterranean Forest Trait Database}\\
\DIFadd{12 }& \DIFadd{Reich }& \DIFadd{Peter }& \DIFadd{94 }& \DIFadd{Global A, N, P, SLA Database}\\
\DIFadd{13 }& \DIFadd{Sosinski }& \DIFadd{Enio }& \DIFadd{77 }& \DIFadd{FAPESP Brazil Rainforest Database}\\
\DIFadd{14 }& \DIFadd{van Bodegom }& \DIFadd{Peter }& \DIFadd{90 }& \DIFadd{Ukraine Wetlands Plant Traits Database}\\
\DIFadd{15 }& \DIFadd{Wright }& \DIFadd{S. Joseph }& \DIFadd{112 }& \DIFadd{Panama Plant Traits Database}\\
\addlinespace
\DIFadd{16 }& \DIFadd{Anand }& \DIFadd{Madhur }& \DIFadd{100 }& \DIFadd{Plant Traits in Pollution Gradients Database}\\
\DIFadd{17 }& \DIFadd{Wright }& \DIFadd{Ian }& \DIFadd{64 }& \DIFadd{Neotropical Plant Traits Database}\\
\DIFadd{18 }& \DIFadd{Poorter }& \DIFadd{Lourens }& \DIFadd{33 }& \DIFadd{Tropical Rainforest Traits Database}\\
\DIFadd{19 }& \DIFadd{Finegan }& \DIFadd{Bryan }& \DIFadd{74 }& \DIFadd{Costa Rica Rainforest Trees Database}\\
\DIFadd{20 }& \DIFadd{Laughlin }& \DIFadd{Daniel }& \DIFadd{193 }& \DIFadd{Plant Traits for Pinus and Juniperus Forests in Arizona}\\
\addlinespace
\DIFadd{21 }& \DIFadd{Kramer }& \DIFadd{Koen }& \DIFadd{191 }& \DIFadd{Baccara - Plant Traits of European Forests}\\
\DIFadd{22 }& \DIFadd{Jansen }& \DIFadd{Steven }& \DIFadd{241 }& \DIFadd{Xylem Functional Traits (XFT) Database}\\
\DIFadd{23 }& \DIFadd{Craven }& \DIFadd{Dylan }& \DIFadd{230 }& \DIFadd{Panama Tree Traits}\\
\DIFadd{24 }& \DIFadd{Gutierrez }& \DIFadd{Alvaro G. }& \DIFadd{123 }& \DIFadd{VirtualForests Trait Database}\\
\DIFadd{25 }& \DIFadd{Powers }& \DIFadd{Jennifer }& \DIFadd{263 }& \DIFadd{Costa Rican Tropical Dry Forest Trees}\\
\addlinespace
\DIFadd{26 }& \DIFadd{Gross }& \DIFadd{Nicolas }& \DIFadd{275 }& \DIFadd{Plant Traits From Spanish Mediteranean shrublands}\\
\DIFadd{27 }& \DIFadd{Wirth }& \DIFadd{Christian }& \DIFadd{68 }& \DIFadd{The Functional Ecology of Trees (FET) Database  - Jena}\\
\DIFadd{28 }& \DIFadd{Adler }& \DIFadd{Peter }& \DIFadd{285 }& \DIFadd{Functional traits explaining variation in plant life history strategies}\\
\DIFadd{29 }& \DIFadd{Higuchi }& \DIFadd{Pedro }& \DIFadd{305 }& \DIFadd{Araucaria Forest Database}\\
\DIFadd{30 }& \DIFadd{Holl }& \DIFadd{Karen }& \DIFadd{306 }& \DIFadd{Plant traits from Costa Rica}\\
\addlinespace
\DIFadd{31 }& \DIFadd{Mazzochini }& \DIFadd{Guilherme }& \DIFadd{357 }& \DIFadd{Functional traits of woody species in the Brazilian semi-arid region}\\
\DIFadd{32 }& \DIFadd{van Bodegom }& \DIFadd{Peter }& \DIFadd{330 }& \DIFadd{Traits of Ukraine native and invasive plant species}\\
\DIFadd{33 }& \DIFadd{Swenson }& \DIFadd{Nathan }& \DIFadd{288 }& \DIFadd{CTFS Luquillo Forest Dynamics Plot}\\
\DIFadd{34 }& \DIFadd{Weigelt }& \DIFadd{Alexandra }& \DIFadd{347 }& \DIFadd{Traits of 59 grassland species}\\
\DIFadd{35 }& \DIFadd{Hietz }& \DIFadd{Peter }& \DIFadd{384 }& \DIFadd{Panama wood anatomy}\\
\addlinespace
\DIFadd{36 }& \DIFadd{Chacon }& \DIFadd{Eduardo }& \DIFadd{377 }& \DIFadd{Functional Traits of Trees in Golfo Dulce, Costa Rica}\\
\DIFadd{37 }& \DIFadd{Rolo Romero }& \DIFadd{Victor }& \DIFadd{396 }& \DIFadd{Rehabilitating Coastal dune forest}\\
\DIFadd{38 }& \DIFadd{Li }& \DIFadd{Yuanzhi }& \DIFadd{419 }& \DIFadd{Sherbrooke}\\
\DIFadd{39 }& \DIFadd{Boonman }& \DIFadd{Coline }& \DIFadd{420 }& \DIFadd{Chinese savanna trees - aboveground trait data}\\
\DIFadd{40 }& \DIFadd{Jacobsen }& \DIFadd{Kim }& \DIFadd{398 }& \DIFadd{Yangambi (DR Congo) tropical forest tree traits}\\
\addlinespace
\DIFadd{41 }& \DIFadd{Paine }& \DIFadd{C. E. Timothy }& \DIFadd{439 }& \DIFadd{Functional Traits of Trees}\\
\DIFadd{42 }& \DIFadd{Lopez-Gonzalez }& \DIFadd{NA }& \DIFadd{413 }& \DIFadd{Zanne et al. Global wood density database.}\\
\DIFadd{43 }& \DIFadd{Silva }& \DIFadd{Ana Carolina }& \DIFadd{393 }& \DIFadd{LABDENDRO Brazilian Subtropical Forest Traits Database }[\DIFadd{Dataset II}]\\
\DIFadd{44 }& \DIFadd{Falster }& \DIFadd{Daniel }& \DIFadd{431 }& \DIFadd{BAAD: a biomass and allometry database for woody plants}\\
\DIFadd{45 }& \DIFadd{Bjorkman }& \DIFadd{Anne }& \DIFadd{468 }& \DIFadd{Tundra Trait Team}\\
\addlinespace
\DIFadd{46 }& \DIFadd{Thomas }& \DIFadd{Evert }& \DIFadd{473 }& \DIFadd{Functional trait data Colombian dry Forest trees}\\
\DIFadd{47 }& \DIFadd{Pausas }& \DIFadd{Juli }& \DIFadd{474 }& \DIFadd{BROT 2.0}\\
\DIFadd{48 }& \DIFadd{Torres-Ruiz }& \DIFadd{Jose M. }& \DIFadd{492 }& \DIFadd{Torres-Ruiz}\\
\DIFadd{49 }& \DIFadd{Schmitt }& \DIFadd{Sylvain }& \DIFadd{532 }& \DIFadd{UppangalaTraits}\\
\DIFadd{50 }& \DIFadd{Laughlin }& \DIFadd{Daniel }& \DIFadd{538 }& \DIFadd{NZ tree traits}\\
\addlinespace
\DIFadd{51 }& \DIFadd{Michelaki }& \DIFadd{Chrysanthi }& \DIFadd{539 }& \DIFadd{Thermo-Mediterranean species along Greece}\\
\DIFadd{52 }& \DIFadd{Richardson }& \DIFadd{Sarah }& \DIFadd{572 }& \DIFadd{New Zealand Nothofagus leaf and stem traits}\\
\DIFadd{53 }& \DIFadd{Schrader }& \DIFadd{Julian }& \DIFadd{587 }& \DIFadd{Raja Ampat tree dataset}\\
\DIFadd{54 }& \DIFadd{Apgaua }& \DIFadd{Deborah }& \DIFadd{622 }& \DIFadd{Daintree Rainforest Functional Traits Data}\\
\DIFadd{55 }& \DIFadd{Tng }& \DIFadd{David }& \DIFadd{625 }& \DIFadd{Tng et al 2013 Traits}\\
\addlinespace
\DIFadd{56 }& \DIFadd{Vasquez }& \DIFadd{Maribel }& \DIFadd{627 }& \DIFadd{functional traits native and invasive species in tropical dry forest}\\
\DIFadd{57 }& \DIFadd{Aubin }& \DIFadd{Isabelle }& \DIFadd{629 }& \DIFadd{Traits of Plants in Canada (TOPIC)}\\
\DIFadd{58 }& \DIFadd{Watkins }& \DIFadd{Harry }& \DIFadd{630 }& \DIFadd{Watkins, Sjoman and Hitchmough CSR ordination of trees}\\
\DIFadd{59 }& \DIFadd{Bruy }& \DIFadd{David }& \DIFadd{632 }& \DIFadd{Atractocarpus from new Caledonia}\\
\DIFadd{60 }& \DIFadd{Olson }& \DIFadd{Mark E. }& \DIFadd{635 }& \DIFadd{Olson PNAS 2018}\\
\addlinespace
\DIFadd{61 }& \DIFadd{Boukili }& \DIFadd{Vanessa }& \DIFadd{636 }& \DIFadd{La Selva FT Data}\\
\DIFadd{62 }& \DIFadd{Olson }& \DIFadd{Mark E. }& \DIFadd{638 }& \DIFadd{Olson et al AnnBot 2018 Corners Rules}\\
\DIFadd{63 }& \DIFadd{VILLACIS }& \DIFadd{JAIME }& \DIFadd{653 }& \DIFadd{RASGOS FUNCIONALES ESPECIES ARBOREAS CUENCA AMAZONICA}\\
\DIFadd{64 }& \DIFadd{Staples }& \DIFadd{Timothy }& \DIFadd{674 }& \DIFadd{Staples et al Australian Reforestation Tree Database}\\
\DIFadd{65 }& \DIFadd{Helsen }& \DIFadd{Kenny }& \DIFadd{706 }& \DIFadd{riparian forb traits W-Europe}\\
\addlinespace
\DIFadd{66 }& \DIFadd{Olson }& \DIFadd{Mark E. }& \DIFadd{708 }& \DIFadd{Olson et al. 2020 Ecological Monographs vessel diameter-plant height scaling}\\
\DIFadd{67 }& \DIFadd{Thom }& \DIFadd{Dominik }& \DIFadd{662 }& \DIFadd{Thom 2019}\\
\DIFadd{68 }& \DIFadd{McCarthy }& \DIFadd{James }& \DIFadd{475 }& \DIFadd{Woody plant traits from southeast Queensland, Australia}\\
\DIFadd{69 }& \DIFadd{Fernndez-Mndez }& \DIFadd{Fernando }& \DIFadd{668 }& \DIFadd{Traits of urban species from Ibagu Colombia}\\
\DIFadd{70 }& \DIFadd{Jansen }& \DIFadd{Steven }& \DIFadd{673 }& \DIFadd{Wagenfhr Woodatlas}\\
\addlinespace
\DIFadd{71 }& \DIFadd{Scalon }& \DIFadd{Marina }& \DIFadd{681 }& \DIFadd{Scalon bark traits}\\
\DIFadd{72 }& \DIFadd{Li }& \DIFadd{Yuanzhi }& \DIFadd{744 }& \DIFadd{Heishiding\_Performance\_Trait\_Environment\_Data}\\
