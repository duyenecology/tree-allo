...
%DIF DEL ms_old.tex   Thu Mar 27 08:00:34 2025
%DIF ADD ms.tex       Thu Mar 27 08:00:06 2025
...
and individual variability (\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citeproc{ref-Laurans2024}{Laurans et al.
2024}}\hspace{0pt}%DIFAUXCMD
; }\DIFdelend e.g., \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citeproc{ref-Poorter2012}{\textbf{Poorter2012?}}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citeproc{ref-Poorter2012a}{Poorter et
al. 2012a}}\hspace{0pt}%DIFAUXCMD
; \mbox{%DIFAUXCMD
\citeproc{ref-Laurans2024}{Laurans et al. 2024}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ).
...
underestimation of dimensions for smaller trees and \DIFdelbegin \DIFdel{underestimation }\DIFdelend \DIFaddbegin \DIFadd{overestimation }\DIFaddend for
...
Detection and Ranging (LiDAR), have revolutionized \DIFdelbegin \DIFdel{monitoring }\DIFdelend \DIFaddbegin \DIFadd{the monitoring of
}\DIFaddend forests (e.g., \citeproc{ref-Jucker2017}{Jucker et al. 2017}) by
...
\citeproc{ref-Jucker2017}{Jucker et al. 2017}). \DIFdelbegin \DIFdel{Because }\DIFdelend \DIFaddbegin \DIFadd{However, because
}\DIFaddend existing allometric models still \DIFdelbegin \DIFdel{depend }\DIFdelend \DIFaddbegin \DIFadd{rely }\DIFaddend on stem diameter as a crucial
input for biomass estimation, \DIFdelbegin \DIFdel{it also presents the challenge of determining the
most effective way to utilize EO technologies for }\DIFdelend \DIFaddbegin \DIFadd{this reliance presents a challenge for
effectively integrating EO technologies into }\DIFaddend AGB estimation
(\citeproc{ref-Shendryk2016}{Shendryk et al. 2016};
...
interplay of plant functional traits and their trade-offs \DIFdelbegin \DIFdel{influences
}\DIFdelend \DIFaddbegin \DIFadd{influence
}\DIFaddend individual tree architecture and the composition of entire forest
...
\citeproc{ref-Fajardo2022}{\textbf{Fajardo2022?}}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citeproc{ref-Fajardo2022a}{Fajardo 2022}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ) and light demand (e.g.,
\citeproc{ref-King2006}{King et al. 2006}; \citeproc{ref-Aiba2009}{Aiba
and Nakashizuka 2009}; \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citeproc{ref-Poorter2012}{\textbf{Poorter2012?}}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citeproc{ref-Poorter2012a}{Poorter et al.
2012a}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ). Several studies suggest that wood density explains a trade-off
...
and species. By integrating species-level wood density \DIFaddbegin \DIFadd{(WD) }\DIFaddend into a
...
level. \DIFaddbegin \DIFadd{Our main objective is to develop models informed by tree
...
estimating above ground biomass. }\DIFaddend Specifically, we ask the following
...
standardized measurements of DBH, height, \DIFaddbegin \DIFadd{and }\DIFaddend crown radius for 5,163
species across various biomes (\citeproc{ref-Jucker2022}{Jucker et al.
2022}\DIFdelbegin \DIFdel{,
https://doi.org/10.5281/zenodo.6637599)along }\DIFdelend \DIFaddbegin \DIFadd{), }\DIFaddend with wood density data for 10,995 species from TRY version 6
(\citeproc{ref-Kattge2020}{Kattge et al. 2020}\DIFdelbegin \DIFdel{, https://www.try-db.org/TryWeb/Home.php}\DIFdelend ) (see Supplementary Table
S1 for further details). \DIFaddbegin \DIFadd{Detailed information on data access and
availability can be found in the Data availability section. }\DIFaddend We
...
Once the best-performing models \DIFdelbegin \DIFdel{were identified }\DIFdelend for each allometric relationship \DIFdelbegin \DIFdel{, we then }\DIFdelend \DIFaddbegin \DIFadd{were
identified, we }\DIFaddend tested whether adding \DIFaddbegin \DIFadd{wood density as }\DIFaddend a species-level
predictor \DIFdelbegin \DIFdel{(wood density) }\DIFdelend would further improve \DIFdelbegin \DIFdel{that model's predictive performance }\DIFdelend \DIFaddbegin \DIFadd{the predictive performance of those
models and also examined its influence on tree architecture diversity}\DIFaddend .
...
deviation of the species-specific parameters. \DIFaddbegin \DIFadd{To facilitate
...
contributes to variation in tree architecture. }\DIFaddend Additionally, we explored
...
\DIFdelbegin \DIFdel{GitHub at }%DIFDELCMD < \url{https://github.com/duyenecology/tree-allometry} %%%
\DIFdel{(}\DIFdelend \DIFaddbegin \DIFadd{Zenodo (https://zenodo.org) and GitHub
(}\url{https://github.com/duyenecology/tree-allo}\DIFadd{). }\DIFaddend Stan code is provided
in Supplementary Section S2\DIFdelbegin \DIFdel{)}\DIFdelend .

\subsection{Aboveground biomass
estimates}\label{aboveground-biomass-estimates}

For angiosperm species, we \DIFdelbegin \DIFdel{estimated aboveground biomass (AGB; kg of dry
mass) using the }\DIFdelend \DIFaddbegin \DIFadd{used the widely applied }\DIFaddend equation from Chave
et al. (\citeproc{ref-Chave2014}{2014}) \DIFaddbegin \DIFadd{to estimate aboveground biomass
(AGB; kg of dry mass)}\DIFaddend :
...
best-performing model, \(\Delta\)\DIFdelbegin \DIFdel{\_}\DIFdelend LOOIC, is also included\DIFaddbegin \DIFadd{, with a
\(\Delta\)LOOIC greater than 4 suggests a meaningful difference in
predictive performance (\mbox{%DIFAUXCMD
\citeproc{ref-Cochrane2023}{Cochrane et al.
2023}}\hspace{0pt}%DIFAUXCMD
; \mbox{%DIFAUXCMD
\citeproc{ref-Sivula2023}{Sivula et al. 2023}}\hspace{0pt}%DIFAUXCMD
)}\DIFaddend . Lower
\(\Delta\)\DIFdelbegin \DIFdel{\_}\DIFdelend LOOIC values indicate models that perform closer to the best
...
\caption{\label{fig-compare}Allometric relationships between \DIFaddbeginFL \DIFaddFL{DBH and
}\DIFaddendFL tree height \DIFdelbeginFL \DIFdelFL{and }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{or }\DIFaddendFL crown radius \DIFdelbeginFL \DIFdelFL{with DBH of angiosperm }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{in angiosperms }\DIFaddendFL (a, c) and \DIFdelbeginFL \DIFdelFL{gymnosperm }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{gymnosperms }\DIFaddendFL (b,
d)\DIFaddbeginFL \DIFaddFL{, }\DIFaddendFL based on three different models: power-law (orange), generalized
Michaelis-Menten (green), and Weibull (blue). \DIFdelbeginFL \DIFdelFL{The density of overlapping
points is shown using a }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{A }\DIFaddendFL color gradient \DIFdelbeginFL \DIFdelFL{ranging }\DIFdelendFL from
black (low density) to yellow (high density) \DIFdelbeginFL \DIFdelFL{. Point }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{indicates the }\DIFaddendFL density \DIFdelbeginFL \DIFdelFL{was }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{of
overlapping data points, }\DIFaddendFL calculated \DIFdelbeginFL \DIFdelFL{using a }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{via }\DIFaddendFL 2D kernel density estimation on
a 300\DIFaddbeginFL \DIFaddFL{\,}\DIFaddendFL \(\times\)\DIFaddbeginFL \DIFaddFL{\,}\DIFaddendFL 300 grid\DIFdelbeginFL \DIFdelFL{, estimating the
concentration of data points in the space of DBH and tree height or
crown radius (see }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{. See }\DIFaddendFL Supplementary Figure S1 for the
log-scale version \DIFdelbeginFL \DIFdelFL{)}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{of these plots}\DIFaddendFL .}
...
allometries \DIFaddbegin \DIFadd{in angiosperms and gymnosperms}\DIFaddend . Each set includes \DIFdelbegin \DIFdel{the best models for angiosperms and
gymnosperms, with posterior
estimates reported }\DIFdelend \DIFaddbegin \DIFadd{posterior
estimates }\DIFaddend both without and with the inclusion of wood density\DIFdelbegin \DIFdel{. Table entries represent the }\DIFdelend \DIFaddbegin \DIFadd{, reported
as }\DIFaddend median and 95\% Bayesian credible intervals for the community-level
parameters of each allometric function. For tree height, the Weibull
model was identified as the best for both \DIFdelbegin \DIFdel{angiosperm and gymnosperm groups}\DIFdelend \DIFaddbegin \DIFadd{clades}\DIFaddend . Crown radius was best
described by a power-law model \DIFdelbegin \DIFdel{for }\DIFdelend \DIFaddbegin \DIFadd{in }\DIFaddend angiosperms and a gMM model for
gymnosperms. The best model for DBH allometry in both \DIFdelbegin \DIFdel{divisions
incorporated }\DIFdelend \DIFaddbegin \DIFadd{clades, which
incorporates }\DIFaddend both tree height and crown radius information (\(CR,H\)
model).
...
\midrule
Tree Height & Angiosperm & Weibull & With & a & \DIFdelbegin \DIFdel{50.0358625836953 (48.0185910757846, 52.2782021867477}\DIFdelend \DIFaddbegin \DIFadd{50.0 (48.0, 52.3}\DIFaddend ) & \DIFdelbegin \DIFdel{1.0030357535955 (0.966279786642521, 1.04204878932111}\DIFdelend \DIFaddbegin \DIFadd{1.00 (0.966, 1.04}\DIFaddend ) & \DIFdelbegin \DIFdel{0.1094080515 (0.08504578, 0.133867675}\DIFdelend \DIFaddbegin \DIFadd{0.109 (0.0850, 0.134}\DIFaddend )\\
Tree Height & Angiosperm & Weibull & With & b & \DIFdelbegin \DIFdel{0.0476521 (0.0456004375, 0.04954112}\DIFdelend \DIFaddbegin \DIFadd{0.0477 (0.0456, 0.0495}\DIFaddend ) & \DIFdelbegin \DIFdel{-0.0002497295 (-0.0018876475, 0.001416113}\DIFdelend \DIFaddbegin \DIFadd{-0.000250 (-0.00189, 0.00142}\DIFaddend ) & \DIFdelbegin \DIFdel{0.0117625713666667 (0.0108990775, 0.01264796}\DIFdelend \DIFaddbegin \DIFadd{0.0118 (0.0109, 0.0126}\DIFaddend )\\
Tree Height & Angiosperm & Weibull & With & k & \DIFdelbegin \DIFdel{0.627988 (0.6179271, 0.638469025}\DIFdelend \DIFaddbegin \DIFadd{0.628 (0.618, 0.638}\DIFaddend ) & \DIFdelbegin \DIFdel{-0.0155465 (-0.025364455, -0.005908563}\DIFdelend \DIFaddbegin \DIFadd{-0.0155 (-0.0254, -0.00591}\DIFaddend ) & \DIFdelbegin \DIFdel{0.141325601 (0.134013175, 0.148615}\DIFdelend \DIFaddbegin \DIFadd{0.141 (0.134, 0.149}\DIFaddend )\\
Tree Height & Angiosperm & Weibull & Without & a & \DIFdelbegin \DIFdel{49.986601524105 (48.0397359146718, 52.1676071716969}\DIFdelend \DIFaddbegin \DIFadd{50.0 (48.0, 52.2}\DIFaddend ) & - & \DIFdelbegin \DIFdel{0.108623839 (0.084699285, 0.13259475}\DIFdelend \DIFaddbegin \DIFadd{0.109 (0.0847, 0.133}\DIFaddend )\\
Tree Height & Angiosperm & Weibull & Without & b & \DIFdelbegin \DIFdel{0.04761845 (0.045788395, 0.0495194425}\DIFdelend \DIFaddbegin \DIFadd{0.0476 (0.0458, 0.0495}\DIFaddend ) & - & \DIFdelbegin \DIFdel{0.0117794441333333 (0.0109647775, 0.012630005}\DIFdelend \DIFaddbegin \DIFadd{0.0118 (0.0110, 0.0126}\DIFaddend )\\
\addlinespace
Tree Height & Angiosperm & Weibull & Without & k & \DIFdelbegin \DIFdel{0.628505 (0.61806375, 0.63871895}\DIFdelend \DIFaddbegin \DIFadd{0.629 (0.618, 0.639}\DIFaddend ) & - & \DIFdelbegin \DIFdel{0.142012394 (0.135037575, 0.1493971}\DIFdelend \DIFaddbegin \DIFadd{0.142 (0.135, 0.149}\DIFaddend )\\
Tree Height & Gymnosperm & Weibull & With & a & \DIFdelbegin \DIFdel{114.392440818366 (85.1394073936058, 170.399810107161}\DIFdelend \DIFaddbegin \DIFadd{114 (85.1, 170}\DIFaddend ) & \DIFdelbegin \DIFdel{0.973669651215167 (0.775709235915639, 1.21272840336665}\DIFdelend \DIFaddbegin \DIFadd{0.974 (0.776, 1.21}\DIFaddend ) & \DIFdelbegin \DIFdel{0.0976113393243333 (0.00465741875, 0.256888}\DIFdelend \DIFaddbegin \DIFadd{0.0976 (0.00466, 0.257}\DIFaddend )\\
Tree Height & Gymnosperm & Weibull & With & b & \DIFdelbegin \DIFdel{0.01226515 (0.00835557525, 0.01627371}\DIFdelend \DIFaddbegin \DIFadd{0.0123 (0.00836, 0.0163}\DIFaddend ) & \DIFdelbegin \DIFdel{0.0006333235 (-0.001878769, 0.003421633}\DIFdelend \DIFaddbegin \DIFadd{0.000633 (-0.00188, 0.00342}\DIFaddend ) & \DIFdelbegin \DIFdel{0.00382281789033333 (0.0022539225, 0.00552581075}\DIFdelend \DIFaddbegin \DIFadd{0.00382 (0.00225, 0.00553}\DIFaddend )\\
Tree Height & Gymnosperm & Weibull & With & k & \DIFdelbegin \DIFdel{0.75131 (0.720762275, 0.78392225}\DIFdelend \DIFaddbegin \DIFadd{0.751 (0.721, 0.784}\DIFaddend ) & \DIFdelbegin \DIFdel{-0.0223577 (-0.053752515, 0.00762075675000001}\DIFdelend \DIFaddbegin \DIFadd{-0.0224 (-0.0538, 0.00762}\DIFaddend ) & \DIFdelbegin \DIFdel{0.11290265 (0.0904752175, 0.139776975}\DIFdelend \DIFaddbegin \DIFadd{0.113 (0.0905, 0.140}\DIFaddend )\\
Tree Height & Gymnosperm & Weibull & Without & a & \DIFdelbegin \DIFdel{117.410929580669 (89.2163884742527, 175.128720630186}\DIFdelend \DIFaddbegin \DIFadd{117 (89.2, 175}\DIFaddend ) & - & \DIFdelbegin \DIFdel{0.0912130060437333 (0.00357252325, 0.229208275}\DIFdelend \DIFaddbegin \DIFadd{0.0912 (0.00357, 0.229}\DIFaddend )\\
\addlinespace
Tree Height & Gymnosperm & Weibull & Without & b & \DIFdelbegin \DIFdel{0.01189855 (0.00806481775, 0.0155006175}\DIFdelend \DIFaddbegin \DIFadd{0.0119 (0.00806, 0.0155}\DIFaddend ) & - & \DIFdelbegin \DIFdel{0.00370917828 (0.00230250075, 0.005250409}\DIFdelend \DIFaddbegin \DIFadd{0.00371 (0.00230, 0.00525}\DIFaddend )\\
Tree Height & Gymnosperm & Weibull & Without & k & \DIFdelbegin \DIFdel{0.750261 (0.71890345, 0.7840528}\DIFdelend \DIFaddbegin \DIFadd{0.750 (0.719, 0.784}\DIFaddend ) & - & \DIFdelbegin \DIFdel{0.113927871366667 (0.0919335325, 0.139492325}\DIFdelend \DIFaddbegin \DIFadd{0.114 (0.0919, 0.139}\DIFaddend )\\
Crown Radius & Angiosperm & Power-Law & With & a & \DIFdelbegin \DIFdel{0.348870320614843 (0.339558002412552, 0.358617649941404}\DIFdelend \DIFaddbegin \DIFadd{0.349 (0.340, 0.359}\DIFaddend ) & \DIFdelbegin \DIFdel{0.067951 (0.0395029625, 0.09696407}\DIFdelend \DIFaddbegin \DIFadd{0.0680 (0.0395, 0.0970}\DIFaddend ) & \DIFdelbegin \DIFdel{0.331462941666667 (0.3107583, 0.353737675}\DIFdelend \DIFaddbegin \DIFadd{0.331 (0.311, 0.354}\DIFaddend )\\
Crown Radius & Angiosperm & Power-Law & With & b & \DIFdelbegin \DIFdel{0.6262655 (0.61724685, 0.6347153}\DIFdelend \DIFaddbegin \DIFadd{0.626 (0.617, 0.635}\DIFaddend ) & \DIFdelbegin \DIFdel{-0.0110058 (-0.01988032, -0.00253456499999999}\DIFdelend \DIFaddbegin \DIFadd{-0.0110 (-0.0199, -0.00253}\DIFaddend ) & \DIFdelbegin \DIFdel{0.0921479955666667 (0.0844064425, 0.100138025}\DIFdelend \DIFaddbegin \DIFadd{0.0921 (0.0844, 0.100}\DIFaddend )\\
Crown Radius & Angiosperm & Power-Law & Without & a & \DIFdelbegin \DIFdel{0.349041308960668 (0.340277352929455, 0.358866706688696}\DIFdelend \DIFaddbegin \DIFadd{0.349 (0.340, 0.359}\DIFaddend ) & - & \DIFdelbegin \DIFdel{0.336416977 (0.315543425, 0.35812015}\DIFdelend \DIFaddbegin \DIFadd{0.336 (0.316, 0.358}\DIFaddend )\\
\addlinespace
Crown Radius & Angiosperm & Power-Law & Without & b & \DIFdelbegin \DIFdel{0.625775 (0.61686365, 0.634504125}\DIFdelend \DIFaddbegin \DIFadd{0.626 (0.617, 0.635}\DIFaddend ) & - & \DIFdelbegin \DIFdel{0.0928698366666667 (0.08518862, 0.101327225}\DIFdelend \DIFaddbegin \DIFadd{0.0929 (0.0852, 0.101}\DIFaddend )\\
Crown Radius & Gymnosperm & gMM & With & a & \DIFdelbegin \DIFdel{975.002465780217 (311.898479923573, 2010.23216629045}\DIFdelend \DIFaddbegin \DIFadd{975 (312, 2010}\DIFaddend ) & \DIFdelbegin \DIFdel{0.98826173732258 (0.765945182590572, 1.26629969928617}\DIFdelend \DIFaddbegin \DIFadd{0.988 (0.766, 1.27}\DIFaddend ) & \DIFdelbegin \DIFdel{0.366709977 (0.27977655, 0.473532775}\DIFdelend \DIFaddbegin \DIFadd{0.367 (0.280, 0.474}\DIFaddend )\\
Crown Radius & Gymnosperm & gMM & With & b & \DIFdelbegin \DIFdel{0.629287 (0.599257875, 0.658672975}\DIFdelend \DIFaddbegin \DIFadd{0.629 (0.599, 0.659}\DIFaddend ) & \DIFdelbegin \DIFdel{0.03446325 (0.00506576425, 0.0642449925}\DIFdelend \DIFaddbegin \DIFadd{0.0345 (0.00507, 0.0642}\DIFaddend ) & \DIFdelbegin \DIFdel{0.0948956725666667 (0.0691086525, 0.126110225}\DIFdelend \DIFaddbegin \DIFadd{0.0949 (0.0691, 0.126}\DIFaddend )\\
Crown Radius & Gymnosperm & gMM & With & k & \DIFdelbegin \DIFdel{3371.455 (1094.23225, 6977.7715}\DIFdelend \DIFaddbegin \DIFadd{3371 (1094, 6978}\DIFaddend ) & \DIFdelbegin \DIFdel{35.71465 (-768.70475, 913.79515}\DIFdelend \DIFaddbegin \DIFadd{35.7 (-769, 914}\DIFaddend ) & \DIFdelbegin \DIFdel{9.363854693469 (0.10023131, 52.3180125}\DIFdelend \DIFaddbegin \DIFadd{9.36 (0.100, 52.3}\DIFaddend )\\
Crown Radius & Gymnosperm & gMM & Without & a & \DIFdelbegin \DIFdel{769.406932080409 (227.345355225331, 1818.30585925327}\DIFdelend \DIFaddbegin \DIFadd{769 (227, 1818}\DIFaddend ) & - & \DIFdelbegin \DIFdel{0.367348107833333 (0.280439875, 0.465157075}\DIFdelend \DIFaddbegin \DIFadd{0.367 (0.280, 0.465}\DIFaddend )\\
\addlinespace
Crown Radius & Gymnosperm & gMM & Without & b & \DIFdelbegin \DIFdel{0.630821 (0.60042295, 0.6625657}\DIFdelend \DIFaddbegin \DIFadd{0.631 (0.600, 0.663}\DIFaddend ) & - & \DIFdelbegin \DIFdel{0.101279463966667 (0.0755376825, 0.130907775}\DIFdelend \DIFaddbegin \DIFadd{0.101 (0.0755, 0.131}\DIFaddend )\\
Crown Radius & Gymnosperm & gMM & Without & k & \DIFdelbegin \DIFdel{2657.085 (808.712975, 6274.33575}\DIFdelend \DIFaddbegin \DIFadd{2657 (809, 6274}\DIFaddend ) & - & \DIFdelbegin \DIFdel{18.9842685191737 (0.11158275, 200.190725}\DIFdelend \DIFaddbegin \DIFadd{19.0 (0.112, 200}\DIFaddend )\\
DBH & Angiosperm & Power-Law & With & a & \DIFdelbegin \DIFdel{0.948873203444669 (0.92824124982295, 0.970115458681121}\DIFdelend \DIFaddbegin \DIFadd{0.949 (0.928, 0.970}\DIFaddend ) & \DIFdelbegin \DIFdel{-0.00254114 (-0.026471175, 0.019015775}\DIFdelend \DIFaddbegin \DIFadd{-0.00254 (-0.0265, 0.0190}\DIFaddend ) & \DIFdelbegin \DIFdel{0.301446662333333 (0.28422895, 0.320054325}\DIFdelend \DIFaddbegin \DIFadd{0.301 (0.284, 0.320}\DIFaddend )\\
DBH & Angiosperm & Power-Law & With & b & \DIFdelbegin \DIFdel{0.3733935 (0.36112825, 0.385692275}\DIFdelend \DIFaddbegin \DIFadd{0.373 (0.361, 0.386}\DIFaddend ) & \DIFdelbegin \DIFdel{-0.003273 (-0.014598435, 0.008914959}\DIFdelend \DIFaddbegin \DIFadd{-0.00327 (-0.0146, 0.00891}\DIFaddend ) & \DIFdelbegin \DIFdel{0.1350893 (0.12519295, 0.145357375}\DIFdelend \DIFaddbegin \DIFadd{0.135 (0.125, 0.145}\DIFaddend )\\
DBH & Angiosperm & Power-Law & With & c & \DIFdelbegin \DIFdel{0.589474 (0.574794525, 0.604623}\DIFdelend \DIFaddbegin \DIFadd{0.589 (0.575, 0.605}\DIFaddend ) & \DIFdelbegin \DIFdel{0.005107385 (-0.00957317475, 0.020006805}\DIFdelend \DIFaddbegin \DIFadd{0.00511 (-0.00957, 0.0200}\DIFaddend ) & \DIFdelbegin \DIFdel{0.167959387666667 (0.1564333, 0.1794579}\DIFdelend \DIFaddbegin \DIFadd{0.168 (0.156, 0.179}\DIFaddend )\\
\addlinespace
DBH & Angiosperm & Power-Law & Without & a & \DIFdelbegin \DIFdel{0.948185804143355 (0.927358177080849, 0.969205798294886}\DIFdelend \DIFaddbegin \DIFadd{0.948 (0.927, 0.969}\DIFaddend ) & - & \DIFdelbegin \DIFdel{0.302088741 (0.2843181, 0.320217575}\DIFdelend \DIFaddbegin \DIFadd{0.302 (0.284, 0.320}\DIFaddend )\\
DBH & Angiosperm & Power-Law & Without & b & \DIFdelbegin \DIFdel{0.373565 (0.361136275, 0.38552}\DIFdelend \DIFaddbegin \DIFadd{0.374 (0.361, 0.386}\DIFaddend ) & - & \DIFdelbegin \DIFdel{0.134749882666667 (0.125359425, 0.145310525}\DIFdelend \DIFaddbegin \DIFadd{0.135 (0.125, 0.145}\DIFaddend )\\
DBH & Angiosperm & Power-Law & Without & c & \DIFdelbegin \DIFdel{0.589786 (0.5749327, 0.604729725}\DIFdelend \DIFaddbegin \DIFadd{0.590 (0.575, 0.605}\DIFaddend ) & - & \DIFdelbegin \DIFdel{0.168123297666667 (0.156878925, 0.180291175}\DIFdelend \DIFaddbegin \DIFadd{0.168 (0.157, 0.180}\DIFaddend )\\
DBH & Gymnosperm & Power-Law & With & a & \DIFdelbegin \DIFdel{0.970943839654932 (0.900241719046287, 1.04481714578926}\DIFdelend \DIFaddbegin \DIFadd{0.971 (0.900, 1.04}\DIFaddend ) & \DIFdelbegin \DIFdel{-0.04506835 (-0.119699575, 0.0295394575}\DIFdelend \DIFaddbegin \DIFadd{-0.0451 (-0.120, 0.0295}\DIFaddend ) & \DIFdelbegin \DIFdel{0.273574103 (0.22492635, 0.338502075}\DIFdelend \DIFaddbegin \DIFadd{0.274 (0.225, 0.339}\DIFaddend )\\
DBH & Gymnosperm & Power-Law & With & b & \DIFdelbegin \DIFdel{0.408055 (0.37113765, 0.443653025}\DIFdelend \DIFaddbegin \DIFadd{0.408 (0.371, 0.444}\DIFaddend ) & \DIFdelbegin \DIFdel{0.02839555 (-0.007731709, 0.0616446325}\DIFdelend \DIFaddbegin \DIFadd{0.0284 (-0.00773, 0.0616}\DIFaddend ) & \DIFdelbegin \DIFdel{0.112309440333333 (0.0845160475, 0.14804745}\DIFdelend \DIFaddbegin \DIFadd{0.112 (0.0845, 0.148}\DIFaddend )\\
\addlinespace
DBH & Gymnosperm & Power-Law & With & c & \DIFdelbegin \DIFdel{0.5880865 (0.538007975, 0.636716225}\DIFdelend \DIFaddbegin \DIFadd{0.588 (0.538, 0.637}\DIFaddend ) & \DIFdelbegin \DIFdel{-0.0363728 (-0.0841089975, 0.0139803}\DIFdelend \DIFaddbegin \DIFadd{-0.0364 (-0.0841, 0.0140}\DIFaddend ) & \DIFdelbegin \DIFdel{0.164765638 (0.127992925, 0.2091867}\DIFdelend \DIFaddbegin \DIFadd{0.165 (0.128, 0.209}\DIFaddend )\\
DBH & Gymnosperm & Power-Law & Without & a & \DIFdelbegin \DIFdel{0.972360848599851 (0.903429908240124, 1.05107834246826}\DIFdelend \DIFaddbegin \DIFadd{0.972 (0.903, 1.05}\DIFaddend ) & - & \DIFdelbegin \DIFdel{0.272779666666667 (0.22238815, 0.3356855}\DIFdelend \DIFaddbegin \DIFadd{0.273 (0.222, 0.336}\DIFaddend )\\
DBH & Gymnosperm & Power-Law & Without & b & \DIFdelbegin \DIFdel{0.409878 (0.3725057, 0.446499075}\DIFdelend \DIFaddbegin \DIFadd{0.410 (0.373, 0.446}\DIFaddend ) & - & \DIFdelbegin \DIFdel{0.114795101166667 (0.0861228225, 0.15017945}\DIFdelend \DIFaddbegin \DIFadd{0.115 (0.0861, 0.150}\DIFaddend )\\
DBH & Gymnosperm & Power-Law & Without & c & \DIFdelbegin \DIFdel{0.587609 (0.540198275, 0.638262825}\DIFdelend \DIFaddbegin \DIFadd{0.588 (0.540, 0.638}\DIFaddend ) & - & \DIFdelbegin \DIFdel{0.165230531666667 (0.129457475, 0.209437675}\DIFdelend \DIFaddbegin \DIFadd{0.165 (0.129, 0.209}\DIFaddend )\\
\bottomrule
\end{longtable*}
\endgroup{}
...
illustrate the 95\% \DIFdelbeginFL \DIFdelFL{CIs}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Bayesian credible intervals}\DIFaddendFL . Only statistically
...
mean square error (RMSE) of 0.279 Mg and the smallest bias of \DIFdelbegin \DIFdel{2.043}\DIFdelend \DIFaddbegin \DIFadd{2.04}\DIFaddend \%
...
biomass \DIFaddbeginFL \DIFaddFL{(AGB) }\DIFaddendFL estimated \DIFdelbeginFL \DIFdelFL{from }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{using }\DIFaddendFL different approaches with reference AGB
...
1:1 relationships, and the solid lines \DIFdelbeginFL \DIFdelFL{are }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{show }\DIFaddendFL linear regression fits to
the data\DIFdelbeginFL \DIFdelFL{points to highlight }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{, highlighting }\DIFaddendFL how predictive accuracy varies with tree size.
...
(\citeproc{ref-Lines2012}{Lines et al. 2012}; \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citeproc{ref-Hulshof2015}{Hulshof et al. 2015}}\hspace{0pt}%DIFAUXCMD
; }\DIFdelend e.g.,
\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citeproc{ref-Poorter2012}{\textbf{Poorter2012?}}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citeproc{ref-Poorter2012a}{Poorter et al. 2012a}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Hulshof2015}{Hulshof et al. 2015}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ), a conclusion
...
(\DIFdelbegin \DIFdel{\(b_{\text{ang}} = 0.625775 \,
\left[ 0.6168636, 0.6345041 \right]\)}\DIFdelend \DIFaddbegin \DIFadd{\(b_{\text{ang}}\) = 0.626 }{[}\DIFadd{0.617, 0.635}{]}\DIFaddend , Table 2). In contrast,
...
\citeproc{ref-Hulshof2015}{Hulshof et al. 2015}\DIFaddbegin \DIFadd{;
\mbox{%DIFAUXCMD
\citeproc{ref-Jucker2024}{Jucker et al. 2024}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ), an adaptation that can
...
2016}\DIFaddbegin \DIFadd{; \mbox{%DIFAUXCMD
\citeproc{ref-Tavankar2019}{Tavankar et al. 2019}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ).
...
DBH (\citeproc{ref-King2005}{King 2005}\DIFaddbegin \DIFadd{; \mbox{%DIFAUXCMD
\citeproc{ref-King2011}{King
and Clark 2011}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ). Among the tested models, the \(CR,H\) model
...
with the previous study (\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citeproc{ref-Poorter2012a}{Poorter et al.
2012}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citeproc{ref-Poorter2012b}{Poorter et al.
2012b}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ), which showed that among seven angiosperm species, those with
...
species identity and environmental factors. \DIFaddbegin \DIFadd{Across species or along
broad environmental gradients, wood density systematically
varies---tending to be denser in drier, colder climates and in
nutrient-poor soils (\mbox{%DIFAUXCMD
\citeproc{ref-Muller-Landau2004}{Muller-Landau
2004}}\hspace{0pt}%DIFAUXCMD
; \mbox{%DIFAUXCMD
\citeproc{ref-Chave2009}{Chave et al. 2009}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Fajardo2022b}{Fajardo et al. 2022}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Mo2024}{Mo et al. 2024}}\hspace{0pt}%DIFAUXCMD
...
(\citeproc{ref-Slik2013}{Slik et al. 2013}\DIFaddbegin \DIFadd{;
\mbox{%DIFAUXCMD
\citeproc{ref-Murphy2022}{Murphy and Bradford 2022}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend )), whose H-DBH
...
\citeproc{ref-Sullivan2018}{Sullivan et al. 2018};
\citeproc{ref-MartinezCano2019}{Martínez Cano et al. 2019}). \DIFdelbegin \DIFdel{Given the
disproportionate contribution of large trees in biomass dynamics }\DIFdelend \DIFaddbegin \DIFadd{Because
large trees contribute disproportionately to overall biomass }\DIFaddend (e.g.,
\citeproc{ref-Slik2013}{Slik et al. 2013};
\citeproc{ref-Fauset2015}{Fauset et al. 2015};
\citeproc{ref-Ligot2018}{Ligot et al. 2018}), \DIFdelbegin \DIFdel{when heights are not
directly measured}\DIFdelend \DIFaddbegin \DIFadd{if direct height
measurements are unavailable}\DIFaddend , height estimates should be derived by
fitting asymptotic models (e.g., Eq.~\ref{eq-gMM}; Eq.~\ref{eq-wb}) to
datasets with sufficient representation of large trees, ensuring \DIFdelbegin \DIFdel{the accurate
capture of }\DIFdelend \DIFaddbegin \DIFadd{that
}\DIFaddend the saturating component \DIFaddbegin \DIFadd{is accurately captured
}\DIFaddend (\citeproc{ref-Sullivan2018}{Sullivan et al. 2018}).
...
Interestingly, our results revealed that\DIFaddbegin \DIFadd{, although }\DIFaddend the \(CR,H\) model
\DIFdelbegin \DIFdel{was more effective in predicting DBH ; however, when these predicted DBH
values
were used to estimate AGB, }\DIFdelend \DIFaddbegin \DIFadd{provided more accurate direct DBH predictions, using those predictions
in the AGB equation resulted in higher RMSE and bias than when DBH
estimates from }\DIFaddend the \(CR \times H\) model \DIFdelbegin \DIFdel{exhibited
substantially lower RMSE and bias }\DIFdelend \DIFaddbegin \DIFadd{were used }\DIFaddend (Fig.~\ref{fig-agb}
...
scales\DIFdelbegin \DIFdel{monitoring practices at global scales}\DIFdelend .
...
We \DIFdelbegin \DIFdel{sincerely }\DIFdelend \DIFaddbegin \DIFadd{thank the editors and two anonymous reviewers, whose comments greatly
improved the manuscript. We also }\DIFaddend thank the Alliance of International
...
MK was supported by the \DIFaddbegin \DIFadd{Xingdian Talent Support Program of Yunnan
Province, the }\DIFaddend Xishuangbanna State Rainforest Talent Support Program
(E4BN041B01)\DIFaddbegin \DIFadd{, }\DIFaddend and the CAS President's International Fellowship
Initiative (2020FYB0003).

\DIFaddbegin \section*{\DIFadd{Data availability}}\label{data-availability}
\addcontentsline{toc}{section}{\DIFadd{Data availability}}

\DIFadd{The tree allometry data is avaiable from tallo
(\mbox{%DIFAUXCMD
\citeproc{ref-Jucker2022}{Jucker et al. 2022}}\hspace{0pt}%DIFAUXCMD
,
https://doi.org/10.5281/zenodo.6637599), and the wood density data are
available on request from TRY version 6
(\mbox{%DIFAUXCMD
\citeproc{ref-Kattge2020}{Kattge et al. 2020}}\hspace{0pt}%DIFAUXCMD
,
}\url{https://www.try-db.org/TryWeb/Home.php}\DIFadd{). All codes and scripts
used for analysis are available on Zenodo (https://zenodo.org) and
GitHub (}\url{https://github.com/duyenecology/tree-allo}\DIFadd{).
}
...
\DIFaddbegin \bibitem[\citeproctext]{ref-Chave2009}
\DIFadd{Chave J, Coomes D, Jansen S, et al (2009) Towards a worldwide wood
economics spectrum. Ecology Letters 12:351--366.
}\url{https://doi.org/10.1111/j.1461-0248.2009.01285.x}

\DIFaddend \bibitem[\citeproctext]{ref-Chave2014}
...
\DIFaddbegin \bibitem[\citeproctext]{ref-Cochrane2023}
\DIFadd{Cochrane A, Sims CR, Bejjanki VR, et al (2023) Multiple timescales of
...
\DIFaddend \bibitem[\citeproctext]{ref-Dormann2013}
...
\DIFaddbegin \bibitem[\citeproctext]{ref-Fajardo2022a}
\DIFadd{Fajardo A (2022) Wood density relates negatively to maximum plant height
...
\DIFadd{Fajardo A, Piper FI, García-Cervigón AI (2022) The intraspecific
...
\DIFaddend \bibitem[\citeproctext]{ref-Falster2017}
...
\DIFaddbegin \bibitem[\citeproctext]{ref-King2011}
\DIFadd{King DA, Clark DA (2011)
}\href{https://www.jstor.org/stable/23012404}{\DIFadd{Allometry of emergent tree
species from saplings to above-canopy adults in a }{\DIFadd{Costa}} {\DIFadd{Rican}} \DIFadd{rain
forest}}\DIFadd{. Journal of Tropical Ecology 27:573--579
}

\DIFaddend \bibitem[\citeproctext]{ref-King2006}
...
\DIFaddbegin \bibitem[\citeproctext]{ref-Muller-Landau2004}
\DIFadd{Muller-Landau HC (2004) Interspecific and }{\DIFadd{Inter}}\DIFadd{-site }{\DIFadd{Variation}} \DIFadd{in
}{\DIFadd{Wood}} {\DIFadd{Specific}} {\DIFadd{Gravity}} \DIFadd{of }{\DIFadd{Tropical}} {\DIFadd{Trees}}\DIFadd{. Biotropica 36:20--32.
}\url{https://doi.org/10.1111/j.1744-7429.2004.tb00292.x}

\bibitem[\citeproctext]{ref-Murphy2022}
\DIFadd{Murphy HT, Bradford MG (2022) The role of big trees and abundant species
in driving spatial patterns of species richness in an }{\DIFadd{Australian}}
\DIFadd{tropical rainforest. Ecology and Evolution 12:e9324.
}\url{https://doi.org/10.1002/ece3.9324}

\DIFaddend \bibitem[\citeproctext]{ref-Niklas2007}
...
Poorter H, Niklas KJ, Reich PB, et al (\DIFdelbegin \DIFdel{2012}\DIFdelend \DIFaddbegin \DIFadd{2012a}\DIFaddend ) Biomass allocation to
...
\DIFaddbegin \bibitem[\citeproctext]{ref-Poorter2012b}
\DIFadd{Poorter L, Lianes E, Moreno-de las Heras M, Zavala MA (2012b)
Architecture of }{\DIFadd{Iberian}} \DIFadd{canopy tree species in relation to wood
density, shade tolerance and climate. Plant Ecology 213:707--722.
}\url{https://doi.org/10.1007/s11258-012-0032-6}

\DIFaddend \bibitem[\citeproctext]{ref-RCoreTeam2023}
...
\DIFaddbegin \bibitem[\citeproctext]{ref-Sivula2023}
\DIFadd{Sivula T, Magnusson M, Matamoros AA, Vehtari A (2023)
}\href{https://doi.org/10.48550/arXiv.2008.10296}{\DIFadd{Uncertainty in
}{\DIFadd{Bayesian}} {\DIFadd{Leave}}\DIFadd{-}{\DIFadd{One}}\DIFadd{-}{\DIFadd{Out}} {\DIFadd{Cross}}\DIFadd{-}{\DIFadd{Validation}} {\DIFadd{Based}} {\DIFadd{Model}}
{\DIFadd{Comparison}}}

\DIFaddend \bibitem[\citeproctext]{ref-Slik2013}
...
\DIFadd{Tavankar F, Lo Monaco A, Nikooy M, et al (2019) Snow damages on trees of
